...
const SEO = {
  title: 'Conrad Express | ขนส่งสินค้ามูลค่าสูงแบบพรีเมียม ส่งทั่วไทย ถึงภายในหนึ่งวัน',
  description: 'บริการจัดส่งพัสดุมูลค่าสูงแบบส่งตรงถึงมือ อุ่นใจขั้นสุดด้วยประสบการณ์มากกว่า 8 ปีและการดูแลอย่างพิถีพิถันทุกขั้นตอน เพื่อให้ทรัพย์สินของคุณถึงปลายทางอย่างปลอดภัยและตรงเวลาอย่างมืออาชีพ ขนส่งเฉพาะทางสำหรับนาฬิกาหรู จิวเวลรี่ งานศิลปะ และสินค้ามูลค่าสูงทั่วไทย ดูแลสินค้าอย่างมืออาชีพ ติดตามแบบเรียลไทม์ รวมถึงชดเชยความเสียหายสูงถึง 50,000 บาท',
