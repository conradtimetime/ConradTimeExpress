  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        { title: 'Pro Gadgets & IT Equipment', desc: 'Delivery for professional cameras, high-value lenses, cinema drones, MacBooks, iPads, and premium gadgets, using shock-resistant packing, secure car transport, or express motorcycle delivery with a locked rear box.' },
      ]
    },
    why: {
  ...
  th: {
    ...
    services: {
      ...
      items: [
        ...
        { title: 'แกดเจ็ตและอุปกรณ์ไอทีระดับโปร', desc: 'จัดส่งกล้องถ่ายภาพระดับมืออาชีพ เลนส์ราคาสูง โดรนถ่ายภาพยนตร์ หรือ MacBook/iPad รุ่นท็อป แพ็กเกจจิ้งแน่นหนาป้องกันแรงสั่นสะเทือน จัดส่งด้วยรถยนต์เพื่อความปลอดภัย หรือส่งด่วนด้วยมอเตอร์ไซค์พร้อมกล่องท้ายนิรภัยล็อกมิดชิด' },
      ]
    },
    why: {
